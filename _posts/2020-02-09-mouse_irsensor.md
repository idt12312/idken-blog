...
この回路は、例えばダイオードと直列にL成分が入ると発振しやすくなるので、回路図上にはありませんが配線のL成分も考えておいたほうがいいです。
発振気味なときは回路図中のoptionalと書かれたCをいれると、Iの応答速度を犠牲に安定性を手に入れることができます。
